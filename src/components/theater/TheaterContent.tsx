    ...
    <section id="about" className="py-24 px-5 md:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          {/* Text */}
          <div>
            <p className="reveal font-montserrat text-[0.9rem] leading-[1.9] text-gray-600 mb-5">Музыкальная комедия «ПОКРОВСКИЕ ВОРОТА» это всем известная история, являющаяся теле бестселлером не одного поколения. 

В нашей версии этой пьесы будет много музыки и движения, но при этом сюжет останется хрестоматийным. 

В инсценировке этой пьесы для нас главным является сохранение атмосферы Москвы 50-60 годов. Пусть мы все моложе или значительно моложе, но у нас есть генная ностальгия и любовь к этому времени, в котором были счастливы наши отцы и деды, мамы и бабушки. У нас есть тяга к этому счастливому времени, в котором рождалась любовь наших родителей, а потом рождались и мы сами!</p>
