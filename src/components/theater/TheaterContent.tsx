      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="reveal font-montserrat text-[0.9rem] leading-[1.9] text-gray-600 mb-8">Пьеса Леонида Зорина — о любви, свободе и невозможности изменить другого человека. 
Вас ждут - яркие костюмы эпохи 50–60-х и звёзды московской антрепризы создают атмосферу настоящего праздника.</p>
